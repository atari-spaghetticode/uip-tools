...
#define writeRTL(addr,data) \
	writeRTL_( addr, data);	

//	printf("wr(" #addr ",%d)\r\n",data ); \

inline void writeRTL_(uint16_t address, unsigned char data)
{
    asm volatile
    (   "   move.l  #0xfb0000,a0         ;"
		" 	move.w %0,D0 				;"
...
inline unsigned char readRTL(uint16_t address)
{
